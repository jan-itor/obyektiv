...
?>
	...
	<?php endif; ?>
      ...
      <span class="dim shareTxt">Поделиться:</span>
      <div class="ya-share2 dim" data-services="vkontakte,facebook,odnoklassniki,twitter,gplus" data-counter=""></div> 
  ...
  <div class="itemLinks">
		...
		<div class="itemCategory">
            ...
            <?
                $linkExp = array_filter(explode("/", $this->item->category->link));
                foreach ($linkExp as $arExp)
                {
                    $link .= "/".$arExp;
                }
            ?>
			<a href="<?=$link?>"><?php echo $this->item->category->name; ?></a>
		</div>
		<?php endif; ?>
	  ...
	  <div class="itemAttachmentsBlock">
		  <ul class="itemAttachments">
            ...
            <?if (stristr($attachment->filename, ".pdf")):?>
            <a href="http://<?=$_SERVER["HTTP_HOST"];?>/media/k2/attachments/<?=$attachment->filename;?>" target="_blank">
                <img src="<?=$this->item->imageMedium;?>" />
            </a>                
            <?else:?>
		    <li>
