	...
	<form action="<?php echo JRoute::_('index.php', true, $params->get('usesecure')); ?>" method="post" name="login" id="form-login">
	  ...
	  <fieldset class="input">
	    <p id="form-login-username">
	      <input value="Логин" onfocus="if (this.value == 'Логин') {this.value = ''; this.style.color = '#000';}" onblur="if (this.value == '') {this.value = 'Логин'; this.style.color = '#777';}" id="modlgn_username" type="text" name="username" class="inputbox" size="18" />
	    </p>
	    <p id="form-login-password">
	      <input value="Пароль" onfocus="if (this.value == 'Пароль') {this.value = ''; this.style.color = '#000';}" onblur="if (this.value == '') {this.value = 'Пароль'; this.style.color = '#777';}" id="modlgn_passwd" type="password" name="<?php echo $passwordFieldName; ?>" class="inputbox" size="18" />
	    </p>
	  ...
	  <ul>
	    ...
	    <li id="regist"><a href="<?php echo $registrationLink; ?>"><?php echo JText::_('K2_CREATE_AN_ACCOUNT'); ?></a></li>
	    <?php endif; ?>
	    <li id="forgpass"><a href="<?php echo $resetLink; ?>"><?php echo JText::_('K2_FORGOT_YOUR_PASSWORD'); ?></a></li>
	  </ul>
